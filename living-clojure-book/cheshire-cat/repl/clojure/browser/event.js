...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj7713 = {};return obj7713;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__3711__auto__ = this$;if(and__3711__auto__)
...
{var x__4360__auto__ = (((this$ == null))?null:this$);return (function (){var or__3723__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__4360__auto__)]);if(or__3723__auto__)
{return or__3723__auto__;
} else
{var or__3723__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__3723__auto____$1)
...
return (function (p__7714){var vec__7715 = p__7714;var k = cljs.core.nth.call(null,vec__7715,(0),null);var v = cljs.core.nth.call(null,vec__7715,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__7716){var vec__7717 = p__7716;var k = cljs.core.nth.call(null,vec__7717,(0),null);var v = cljs.core.nth.call(null,vec__7717,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
